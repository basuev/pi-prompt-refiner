...
2. Call `refine_prompt` once with that prompt unchanged; the tool supplies relevant session context.
3. Return the tool's refined prompt verbatim in a Markdown code block. Add no critique or alternate version unless the user asks for one.
